class User < ActiveRecord::Base
  ...
  # ????: (adam) I think line doesn't do anything. Devise already handles email uniqueness
  # NOTE: It appears that validates_uniqueness_of is using an unscoped query to check uniqueness
