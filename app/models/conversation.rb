class Conversation < ActiveRecord::Base
  ...
  MESSAGE_BODY = "Welcome to Flatiron Pediatrics! My name is Catherine and I run the office here
                  at Flatiron Peds. If you every need to reach us with questions, concerns or requests, feel free to use
                  this messaging channel and we'll get back to you right away."
