module Leo
  module Entities
    class MessageEntity < Grape::Entity
      ...
      expose :escalated_to, with: Leo::Entities::UserEntity, documentation: {type: "object", desc: "The physician who the message has been escalated to." }
      expose :escalated_by, with: Leo::Entities::UserEntity, documentation: {type: "object", desc: "The staff who the message has been escalated by." }
