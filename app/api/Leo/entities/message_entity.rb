class Leo::Entities::MessageEntity < Grape::Entity
  expose :id
  ...
  expose :escalated_to, with: V1::Entities::ConversationParticipantEntity, documentation: {type: "object", desc: "The physician who the message has been escalated to." }
  expose :escalated_by, with: V1::Entities::ConversationParticipantEntity, documentation: {type: "object", desc: "The staff who the message has been escalated by." }
