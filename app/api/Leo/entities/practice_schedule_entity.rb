    ...
    class PracticeScheduleEntity < Grape::Entity
      ...
      def daily_hours
        [
          ...
          { id: 6, start_time: object.saturday_start_time, end_time: object.saturday_end_time, day_of_the_week: "saturday" },
          { id: 7, start_time: object.sunday_start_time, end_time: object.sunday_end_time, day_of_the_week: "sunday" }
        ]
      end
    end
  end
