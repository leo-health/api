      ...
      helpers do
        def update_or_create_subscription
          ...
          begin
            ...
            error!({error_code: 500, error_message: "Stripe::AuthenticationError #{e.to_s}" }, 500)
            ...
            error!({error_code: 500, error_message: "Stripe::RateLimitError APIConnectionError #{e.to_s}" }, 500)
