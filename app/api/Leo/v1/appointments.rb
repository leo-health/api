module Leo
  module V1
    module Entities
      ...
      class AppointmentDetailed < V1::Entities::Appointment
        expose :family_id
      end

      class AppointmentDetailedWithAthena < V1::Entities::AppointmentDetailed
    ...
    class Appointments < Grape::API
      ...
      resource :appointments do
        ...
        # get "/appointmeents"
        get do
          present Appointment.for_user(current_user), with: V1::Entities::Appointment
        end
