  ...
  module V1
    class AppointmentSlots < Grape::API
      resource :appointment_slots do
        ...
        # get "appointment_slots?start_date=01/01/2015&end_date=02/01/2015&appointment_type=2&provider_id=6"
        ...
        params do
          ...
          requires :appointment_type, type: Integer, desc: "Appointment Type", allow_blank: false
          requires :provider_id, type: Integer, desc: "Provider Id", allow_blank: false
        end
        get do
          open_slots = []

          type = AppointmentType.find(params[:appointment_type])
