    ...
    class Sessions < Grape::API
      resource :sessions do
        ...
        post do
          ...
          session_params = params.slice(:device_token, :apns_permissions, :device_type, :os_version, :platform, :client_version, :authentication_token)
      ...
      namespace :login do
        ...
        post do
          ...
          session_params = params.slice(:device_token, :apns_permissions, :device_type, :os_version, :platform, :client_version)
