...
begin
  ...
  syncServiceUser = User.create_with(first_name: 'Guardian', last_name: 'SyncService', password: 'SyncService-password', phone: '0000000000', vendor_id:"fakevendorid", role: Role.find_by(name: :guardian), practice: Practice.first)
