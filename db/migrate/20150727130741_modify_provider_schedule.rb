  ...
  def change
    reversible do |dir|
      dir.up {
        ...
        add_column :provider_schedules, :monday_start_time, :string, null: false
        add_column :provider_schedules, :monday_end_time, :string, null: false
        add_column :provider_schedules, :tuesday_start_time, :string, null: false
        add_column :provider_schedules, :tuesday_end_time, :string, null: false
        add_column :provider_schedules, :wednesday_start_time, :string, null: false
        add_column :provider_schedules, :wednesday_end_time, :string, null: false
        add_column :provider_schedules, :thursday_start_time, :string, null: false
        add_column :provider_schedules, :thursday_end_time, :string, null: false
        add_column :provider_schedules, :friday_start_time, :string, null: false
        add_column :provider_schedules, :friday_end_time, :string, null: false
        add_column :provider_schedules, :saturday_start_time, :string, null: false
        add_column :provider_schedules, :saturday_end_time, :string, null: false
        add_column :provider_schedules, :sunday_start_time, :string, null: false
        add_column :provider_schedules, :sunday_end_time, :string, null: false
      }
